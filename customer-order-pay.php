...
?>
            ...
            <div class="page-banner" style="background-image: url(assets/uploads/<?php echo $contact_banner; ?>);">
                <div class="inner">
                    <h1><?php echo LANG_VALUE_24; ?> | To Pay</h1>
                </div>
                </div>
    ...
    <div class="row">
        <div class="col-md-12">
                ...
                <ul class="nav nav-tabs" id="scroll" style="">
                        ...
                        <li class="active"><a href="customer-order-pay" data-toggle="tab">To Pay<?php if ($to_pay == 0 ) { echo ''; }else { echo '<span class="count">'.$to_pay.'</span>';}?></a></li>
...
<?php
            ...
            $targetpage = BASE_URL.'customer-order-pay.php';
            $limit = 10;
            $page = @$_GET['page'];
            if($page) 
                $start = ($page - 1) * $limit;
            ...
            $statement = $pdo->prepare("SELECT * FROM tbl_payment WHERE customer_email=? AND order_status!='Accepted' AND order_status!='Declined' AND payment_status!='Paid'  ORDER BY id DESC LIMIT $start, $limit");
            $statement->execute(array($_SESSION['customer']['cust_email']));
