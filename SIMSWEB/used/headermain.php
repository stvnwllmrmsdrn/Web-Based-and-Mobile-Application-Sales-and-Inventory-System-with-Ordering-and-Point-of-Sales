...
<body>
			...
			<div class="container">
				...
				<div class="header-user-actions">
					...
					<div class="top-header">
						<button class="action-btn">
							<div class="top-header__btn-cart" type="button" aria-controls="cart-section" aria-expanded="false"><ion-icon name="bag-handle-outline"></ion-icon></span>

									<span class="items-quantity">
										<span class="value">0</span><span class="sr-only">items</span>
									</span>
									
							<div class="user-container" type="button" aria-label="User section"></div></button>
    ...
    <div class="mobile-bottom-navigation">
      ...
      <button class="action-btn"><a href="dashboard.php">
        <ion-icon name="heart-outline"></ion-icon>
        </a></button>
