...
if(isset($_POST['form1'])) {
    ...
    if(empty($_POST['size_name'])) {
        $valid = 0;
        $error_message .= "Unit of Measurement can not be empty<br>";
    } else {
    	...
    	if($total) {
    		$valid = 0;
        	$error_message .= 'Unit of Measurements already exists<br>';
    	}
    }
    ...
    if($valid == 1) {    	
    	...
    	$success_message = 'Unit of Measurements is updated successfully.';
    }
}
?>
