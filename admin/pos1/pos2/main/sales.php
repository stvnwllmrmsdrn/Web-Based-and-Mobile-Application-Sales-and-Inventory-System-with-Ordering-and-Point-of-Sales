...
<input type="number" name="qty" value="1" min="1" placeholder="" autocomplete="off" style="width: 75px; height:30px; padding-top:4px; padding-bottom: 4px; margin-right: 4px; font-size:15px;" / required>
...
<table class="table table-bordered" id="resultTable" data-responsive="table" required>
	...
	<tbody>
			...
			<tr>
				...
				<th colspan="3"><strong style="font-size: 14px; color: #222222;">Total:</strong></th>
