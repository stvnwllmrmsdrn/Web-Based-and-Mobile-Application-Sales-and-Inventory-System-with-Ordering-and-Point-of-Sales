...
if(isset($_POST['form1'])) {
    ...
    if(empty($_POST['size_name'])) {
        $valid = 0;
        $error_message .= "Unit of Measurement Name can not be empty<br>";
    } else {
    	...
    	{
    		$valid = 0;
        	$error_message .= "Unit of Measurement Name already exists<br>";
    	}
    }
    ...
    if($valid == 1) {
    	...
    	$success_message = 'Unit of Measurement is added successfully.';
    }
}
?>
				...
				<div class="box box-info">
					<div class="box-body">
						<div class="form-group">
							<label for="" class="col-sm-2 control-label">Unit of Measurements <span>*</span></label>
							<div class="col-sm-4">
