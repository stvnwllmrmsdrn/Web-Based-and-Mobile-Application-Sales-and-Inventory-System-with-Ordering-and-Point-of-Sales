...
$statement = $pdo->prepare("SELECT * FROM tbl_supplier WHERE p_id=?");
$statement->execute(array($_REQUEST['id']));
$result = $statement->fetchAll(PDO::FETCH_ASSOC);							
foreach ($result as $row) {
	$supplier_id[] = $row['supplier_id'];
						...
						<div class="form-group">
							...
							<div class="col-sm-1">
								<input type="text" onkeypress="return event.charCode >= 48 && event.charCode <= 57"
                                    title="Numbers only" name="p_old_price" class="form-control" value="<?php echo $p_old_price; ?>">
							</div>
						</div>	
						<div class="form-group">
							...
							<div class="col-sm-1">
								<input type="text" onkeypress="return event.charCode >= 48 && event.charCode <= 57"
                                    title="Numbers only" name="p_current_price" class="form-control" value="<?php echo $p_current_price; ?>">
							</div>
						</div>	
						<div class="form-group">
							<label for="" class="col-sm-3 control-label">Walk-in Price <span>*</span></label>
							<div class="col-sm-1">
								<input type="text" onkeypress="return event.charCode >= 48 && event.charCode <= 57"
                                    title="Numbers only" name="p_walkin_price" class="form-control" value="<?php echo $p_walkin_price; ?>">
							</div>
						</div>	
						<div class="form-group">
							...
							<div class="col-sm-1">
								<input type="text" onkeypress="return event.charCode >= 48 && event.charCode <= 57"
                                    title="Numbers only" name="p_qty" class="form-control" value="<?php echo $p_qty; ?>">
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-sm-4">
								<input type="text" onkeypress="return event.charCode >= 48 && event.charCode <= 57"
                                    title="Numbers only" name="reorder_level" class="form-control" value="<?php echo $reorder_level; ?>">
							</div>
						</div>
						<div class="form-group">
							<label for="" class="col-sm-3 control-label">Purchase Date <span></span></label>
							<div class="col-sm-4">
								<input type="date" name="date_today" class="form-control" value="<?php echo $date_today; ?>"><small>Optional</small>
							</div>
						</div>
						<div class="form-group">
							<label for="" class="col-sm-3 control-label">Expiration Date <span></span></label>
							<div class="col-sm-4">
								<input type="date" name="date_expire" class="form-control" value="<?php echo $date_expire; ?>"><small>Optional</small>
							</div>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<div class="col-sm-4">
								<select name="supplier_id" class="form-control">
		                            ...
		                            foreach ($result as $row) {
		                                ?>
		                                <option value="<?php echo $row['supplier_id']; ?>" <?php if($row['supplier_id'] == $supplier_id){echo 'selected';} ?>><?php echo $row['supplier_name']; ?></option>
		                                <?php
		                            }
		                            ?>
		                        </select>
