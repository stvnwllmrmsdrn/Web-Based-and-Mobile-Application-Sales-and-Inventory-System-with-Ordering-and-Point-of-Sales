...
<?php
	...
	$statement = $pdo->prepare("UPDATE tbl_payment SET shipping_status=?, shipping_date=? WHERE id=?");
	...
	foreach ($result as $row) {
		...
		$order_detail .= '
			...
			<tr>
			<td align="left" style="padding:0;Margin:0;padding-left:10px"><p style="Margin:5px;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;line-height:21px;color:#333333;font-size:14px;width: 100%;"><strong>Payment Status: <b> '.$row['payment_status'].'</strong></p></td>
			</tr>
			<tr>
			<td align="left" style="padding:0;Margin:0;padding-bottom:10px;padding-left:10px"><p style="Margin:5px;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;line-height:21px;color:#333333;font-size:14px;width: 100%;"><strong>Shipping Status: <b> '.$row['shipping_status'].'</strong></p></td>
			</tr>
			</table>
	...
	$subject = 'Standly Hardware || Order #'.$payment_id.' Shipping Status ';
	$message = '
							  ...
							  <tr>
							   <td align="center" valign="top" style="padding:0;Margin:0;width:560px">
								<table cellpadding="0" cellspacing="0" width="100%" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
								  ...
								  <tr>
								   <td align="left" style="padding:0;Margin:0;padding-top:10px;padding-bottom:10px"><p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;line-height:24px;color:#333333;font-size:16px">Hello <b>'.$cust_name.'</b>, Your order #'.$row['payment_id'].' has been Picked Up.  <br>
