...
<section class="content-header">
	<div class="content-header-left">
		<h1>Walk-in Highest Sales Products </h1>
	</div>
	<div>
	<a href ="PrintHighestEarningsWalkin.php" style="float:right;" class="btn btn-success btn-sm"> Print</a>
</div>
						...
						<tbody>
							...
							foreach ($result as $row) {
								...
								<tr class ="bg-g">
									...
									<td><p style ="color:black;"><?php echo $row['totqty']; ?></td>
