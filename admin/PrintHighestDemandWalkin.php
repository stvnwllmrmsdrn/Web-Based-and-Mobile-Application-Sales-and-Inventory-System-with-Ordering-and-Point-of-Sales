...
$html = file_get_contents("PrintHighestDemandProductWalkin.html");

// Replace the placeholder "{{data}}" with the actual data
$html = str_replace(["{{dataHighDemandWalkin}}","{{date}}"], [$dataHighDemandWalkin,$date], $html);
...
$dompdf->stream("Standly - High Demand Product Walkin - $date.pdf", array("Attachment" => false));

// Clear any output buffers
ob_end_clean();

// Output the generated PDF to the browser
// $dompdf->stream("Standly - High Demand Product Walkin - $date.pdf", ["Attachment" => 0]);
?>
