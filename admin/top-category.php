          ...
          <table id="example1" class="table table-bordered table-hover table-striped">
            ...
            <tbody>
            	...
            	foreach ($result as $row) {
					...
					<tr>
	                    <td><?php echo $i; ?></td>
                        <td style="width:10px;"><img src="../assets/uploads/<?php echo $row['photo']; ?>" alt="<?php echo $row['tcat_name']; ?>" style="width:60px;"></td>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <p style="color:red;">Be careful! All products, Sub Categories and End Categories under this Main Category will be deleted from all the tables like order table, payment table, size table, color table, rating table etc.</p>
            </div>
