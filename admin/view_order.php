...
<section class="content-header">
	...
	<div>
	 <!--<a href ="view_order_page.php" class="btn btn-primary btn-l" style ="float:right; margin-left: 2px;"> View All</a></h1>-->
...
<div style="margin: 0 auto; padding: 20px; width: 90%; font-weight: normal;">
	<table border="5" cellpadding="4"style=" text-align:right;border: 2px solid black;" cellspacing="5" style="font-family: arial; font-size: 14px;	text-align:left;" width="100%">
		<thead >
			<tr><h3>ORDER ID#:<?php echo $_REQUEST['payment_id']; ?></h3></tr>
			<tr>
			<th width ="5%"><p style="text-align: center;">#</th>
				<th width ="15%"> <p style="text-align: center;">Photo </th>
				<th width ="15%"><p style="text-align: center;"> Product Name </th>
				<th width ="10%"><p style ="text-align: center;"> Unit of Measurement </th>
