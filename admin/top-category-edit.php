...
if(isset($_POST['form1'])) {
    ...
    if(empty($_POST['tcat_name'])) {
        $valid = 0;
        $error_message .= "Main Category Name can not be empty<br>";
    } else {
    	...
    	if($total) {
    		$valid = 0;
        	$error_message .= 'Main Category name already exists<br>';
    	}
    }
    ...
    if($valid == 1) {    	
    	...
    	$success_message = 'Main Category is updated successfully.';
    }
}
?>
