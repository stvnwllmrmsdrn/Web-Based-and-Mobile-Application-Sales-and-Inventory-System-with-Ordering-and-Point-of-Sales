...
if(isset($_POST['form1'])) {
    ...
    if(empty($_POST['city_name'])) {
		...
		$statement = $pdo->prepare("SELECT * FROM tbl_city WHERE city_name=? and city_name!=?");
    	$statement->execute(array($_POST['city_name'],$current_city_name));
    ...
    if($valid == 1) {    	
		...
		$statement = $pdo->prepare("UPDATE tbl_city SET city_name=? WHERE city_id=?");
		$statement->execute(array($_POST['city_name'],$_REQUEST['id']));
