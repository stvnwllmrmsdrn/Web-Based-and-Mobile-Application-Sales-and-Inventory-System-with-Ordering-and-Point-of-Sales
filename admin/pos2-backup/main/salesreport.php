...
<!--/span-->
	...
	<div class="contentheader">
			<i class="icon-bar-chart"></i> POS Customer Transaction Reports
			</div>
			<ul class="breadcrumb">
...
<table class="table table-bordered" id="resultTable" data-responsive="table" style="text-align: left;">
	...
	<tbody>
			...
			<?php
				...
				$d1=$_GET['d1'];
				$d2=$_GET['d2'];
				$result = $db->prepare("SELECT * FROM tbl_sales_pos, WHERE date BETWEEN :a AND :b ORDER by transaction_id DESC ");
			...
			?>
			<tr class="record">
			<td>SH0<?php echo $row['transaction_id']; ?></td>
