...
if($position=='cashier') {
?>
<a href="index.php=<?php echo $finalcode ?>">Cash</a>
...
<option></option>
	<?php
	include('../connect.php');
	$result = $db->prepare("SELECT * FROM tbl_product");
		$result->execute();
...
<table class="table table-bordered" id="resultTable" data-responsive="table">
	...
	<tbody>
			...
			<tr>
				...
				<td colspan="1">₱ <strong style="font-size: 12px; color: #222222;">
			<?php 
				$resulta = $db->prepare("SELECT sum(profit) FROM tbl_salesorder_pos WHERE invoice= :b");
...
<a rel="facebox" href="checkout.php?pt=<?php echo $_GET['id']?>&invoice=<?php echo $_GET['invoice']?>&total=<?php echo $fgfg ?>&totalprof=<?php echo $asd ?>&cashier=<?php echo $_SESSION['SESS_FIRST_NAME']?>"><button class="btn btn-success btn-large btn-block"><i class="icon icon-arrow-right"></i> Process Order</button></a>
