...
<section class="content-header">
	...
	<div>
<a href ="PrintRegisteredCustomer.php" style ="float:right;" class="btn btn-success btn-sm"> Print</a>
</div>
</section>
					...
					<table id="example1" class="table table-bordered table-hover table-striped">
						<thead>
							<tr>
								...
								<th width="180">Country, City, Province</th>
								<th>Status</th>
						...
						<tbody>
							...
							$statement = $pdo->prepare("SELECT * 
														...
														JOIN tbl_city t3
														ON t1.cust_city = t3.city_id
														JOIN tbl_state t4
														ON t1.cust_state = t4.state_id
							...
							foreach ($result as $row) {
								...
								<tr class="<?php if($row['cust_status']==1) {echo 'bg-g';}else {echo 'bg-r';} ?>">
									<td><?php echo $i; ?></td>
									<td><?php echo $row['cust_name']; ?> <?php echo $row['cust_cname']; ?></td>
