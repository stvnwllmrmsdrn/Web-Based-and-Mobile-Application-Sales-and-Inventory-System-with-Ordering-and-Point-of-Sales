...
$html = file_get_contents("PrintHighestEarningsOnline.html");

// Replace the placeholder "{{data}}" with the actual data
$html = str_replace(["{{dataEarningsOnlineHighest}}","{{date}}"], [$dataEarningsOnlineHighest,$date], $html);
...
$dompdf->stream("Standly - Highest Sales Product Online - $date.pdf", array("Attachment" => false));

// Clear any output buffers
ob_end_clean();

// Output the generated PDF to the browser
// $dompdf->stream("Standly - Highest Sales Product Online - $date.pdf", ["Attachment" => 0]);
?>
