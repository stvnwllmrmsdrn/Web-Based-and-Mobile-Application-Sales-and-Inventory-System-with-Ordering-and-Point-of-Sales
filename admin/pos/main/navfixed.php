 <div class="navbar navbar-inverse navbar-fixed-top">
      <div class="navbar-inner">
        ...
        <li><a href="../../index.php" class="btn btn-primary bt-lg active"> ADMIN PANEL</a></li>
              <li><a href="../../login.php"><font color="red" class="btn btn-danger bt-lg active"><i class="icon-off icon-large"></i>LOGOUT</font></a></li>
            </ul>
          </div><!--/.nav-collapse -->
        </div>
      </div>
