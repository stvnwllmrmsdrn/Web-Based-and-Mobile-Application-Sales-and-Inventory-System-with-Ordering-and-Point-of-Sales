...
<table class="table table-bordered" id="resultTable" data-responsive="table" style="text-align: left;">
	...
	<tbody>
			...
			<?php
				...
				$c='credit';
				$d='paid';
				$result = $db->prepare("SELECT * FROM tbl_sales_pos WHERE type=:c AND due_date!= :d AND date BETWEEN :a AND :b");
	...
	<thead>
		<tr>
			...
			<?php
				...
				$d2=$_GET['d2'];
				$c='credit';
				$results = $db->prepare("SELECT sum(amount) FROM tbl_sales_sales WHERE type=:c AND date BETWEEN :a AND :b");
