...
$html = file_get_contents("PrintLowDemandProductOnline.html");

// Replace the placeholder "{{data}}" with the actual data
$html = str_replace(["{{dataLowDemandOnline}}","{{date}}"], [$dataLowDemandOnline,$date], $html);
...
$dompdf->stream("Standly - Lowest Demand Product Online -$date.pdf", array("Attachment" => false));

// Clear any output buffers
ob_end_clean();

// Output the generated PDF to the browser
// $dompdf->stream("Standly - Lowest Demand Product Online -$date.pdf", ["Attachment" => 0]);
?>
