...
<div class="login-box">
	...
	<legend  class=" text-center"><img src="img/logo.png" alt="Standley's logo" width="320" height="70"><br></legend>
  	...
  	<div class="login-box-body">
    	<h4><p class="login-box-msg"><b>ADMIN PANEL</b></p></h4>
		...
		<form action="" method="post">
			...
			<div class="row">
				...
				<div class="col-xs-8"></div>
				<div class="col-xs-4" >
					<a href="pos2/index.php">
				<input type="button" href="pos2/index.php" class="btn btn-large btn-primary btn-block pull-right" value="Log in as Cashier"></a><br><br>
				</div>
...
<script src="js/jquery-2.2.3.min.js"></script>s
