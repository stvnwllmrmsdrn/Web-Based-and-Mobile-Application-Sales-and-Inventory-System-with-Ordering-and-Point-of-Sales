...
<div class="page-banner" style="background-image: url(assets/uploads/<?php echo $contact_banner; ?>);">
                <div class="inner">
                <h1><?php echo LANG_VALUE_86; ?> & <?php echo LANG_VALUE_87; ?></h1>
                </div>
            </div><br>
...
<?php require_once('usernave.php'); ?> 
            ...
            <div class="row">
                  ...
                  title="Numbers only" class="form-control" name="cust_b_phone" value="<?php echo $_SESSION['customer']['cust_b_phone']; ?>">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="cust_b_city" class="form-control">
                                        <?php
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="cust_b_state" class="form-control">
                                        <?php
                                        ...
                                        foreach ($result as $row) {
                                            ?>
                                            <option value="<?php echo $row['state_id']; ?>" <?php if($row['state_id'] == $_SESSION['customer']['cust_b_state']) {echo 'selected';} ?>><?php echo $row['state_name']; ?></option>
                                            <?php
                                        }
                                        ?>
                                    </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" onkeypress="return event.charCode >= 48 && event.charCode <= 57"
                  title="Numbers only" class="form-control" name="cust_b_zip" value="<?php echo $_SESSION['customer']['cust_b_zip']; ?>">
                                </div>
                            </div>
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    <label for=""><?php echo LANG_VALUE_104; ?></label>
                                    <input type="number" onkeypress="return event.charCode >= 48 && event.charCode <= 57"
                  title="Numbers only" class="form-control" name="cust_s_phone" value="<?php echo $_SESSION['customer']['cust_s_phone']; ?>">
                                </div>
                                <div class="form-group">
                                    <label for=""><?php echo LANG_VALUE_106; ?></label>
                                ...
                                <div class="form-group">
                                    <label for=""><?php echo LANG_VALUE_107; ?></label>
                                    <select name="cust_s_city" class="form-control">
                                        <?php
                                        $statement = $pdo->prepare("SELECT * FROM tbl_city ORDER BY city_name ASC");
                                        $statement->execute();
                                        $result = $statement->fetchAll(PDO::FETCH_ASSOC);
                                ...
                                <div class="form-group">
                                    <label for=""><?php echo LANG_VALUE_108; ?></label>
                                    <select name="cust_s_state" class="form-control">
                                        <?php
                                        $statement = $pdo->prepare("SELECT * FROM tbl_state ORDER BY state_name ASC");
                                        $statement->execute();
                                        $result = $statement->fetchAll(PDO::FETCH_ASSOC);
                                        foreach ($result as $row) {
                                            ?>
                                            <option value="<?php echo $row['state_id']; ?>" <?php if($row['state_id'] == $_SESSION['customer']['cust_s_state']) {echo 'selected';} ?>><?php echo $row['state_name']; ?></option>
                                            <?php
                                        }
                                        ?>
                                    </select>
                                ...
                                <div class="form-group">
                                    <label for=""><?php echo LANG_VALUE_109; ?></label>
                                    <input type="number" onkeypress="return event.charCode >= 48 && event.charCode <= 57"
                  title="Numbers only" class="form-control" name="cust_s_zip" value="<?php echo $_SESSION['customer']['cust_s_zip']; ?>">
                                </div>
                            </div>
                        </div>
