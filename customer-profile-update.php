...
<div class="containerc">
    <section class="content">
				...
				<div class="nav-tabs-custom">
                                                ...
                                                <h3>Edit Profile</h3>
                                                    <?php 
                                                        if(empty($_SESSION['customer']['photo'])) {
                                                            ?>
                                                                <img class="profile" src="assets/uploads/<?php echo $favicon; ?>">
                                                            <?php
                  ...
                  title="Numbers only" class="form-control" name="cust_phone" value="<?php echo $_SESSION['customer']['cust_phone']; ?>">
                                            </div>
                                            ...
                                            <div class="col-md-6 form-group">
                                                ...
                                                <input type="number" onkeypress="return event.charCode >= 48 && event.charCode <= 57"
                  title="Numbers only" class="form-control" name="cust_zip" value="<?php echo $_SESSION['customer']['cust_zip']; ?>">
                                            </div>
                                                ...
                                                <div class="form-group"><br>
                                                    ...
                                                    <h3>Edit Profile Picture</h3>
                                                        ...
                                                        <div class="col-sm-12" style="padding:20px;text-align-last: center;">
                                                            <input type="file" name="photo" id="form2form">
                                                        </div>
                                                        
                                                        <div class="form-group">
                                                            <div class="col-sm-12">
                                                                <input type="submit" class="btn btn-primary" value="Update Photo" name="form2" id="form2button">
                                                            </div>
                                                        </div>
                                            </div>
                                        </div>
...
$(document).ready(function () {
    form2form = $('#form2form').val();

        $('#form2button').prop("disabled", true);
        if ( form2form == '' ) {
              $('#form2button').prop("disabled", true);
        }
        $('#form2form').on('change',function() {
            form2form = $('#form2form').val();
            if ( form2form == '' ) {
            	$('#form2button').prop("disabled", true);
            }else {
