...
if ( (!isset($_REQUEST['email'])) || (isset($_REQUEST['token'])) )
{
    ...
    if($var != 0)
    {
        ...
        $success_message = '<p style="color:green;">Your email is verified successfully. You can now login to our website.</p><p><a href="'.BASE_URL.'login" style="color:#167ac6;font-weight:bold;">Click here to login</a></p>';     
    }
}
?>
<title> <?php echo $meta_keyword_home; ?></title>
